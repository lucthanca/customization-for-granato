...
/**
 * Add final_price_incl_tax fled for result
 * @see self::formatTierPrices
 */
class PriceTiers extends \Magento\CatalogCustomerGraphQl\Model\Resolver\PriceTiers implements ResolverInterface
{
    ...
    private function formatAndFilterTierPrices(
        ...
        foreach ($tierPrices as $key => $tierPrice) {
            ...
            $this->formatTierPrices($productPrice, $currencyCode, $tierPrice, $product);
     ...
     */
    private function formatTierPrices(float $productPrice, string $currencyCode, $tierPrice, $product)
    {
        ...
        $this->formatAndFilterTierPrices[] = [
            ...
            "final_price_incl_tax" => [
                "value" => $this->taxHelper->getTaxPrice($product, $tierPrice->getValue(), true),
                "currency" => $currencyCode
            ]
        ];
    }
